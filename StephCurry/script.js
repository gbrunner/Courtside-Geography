...
require([
  ...
  FeatureLayer, TileLayer, Map, SimpleRenderer, ExtrudeSymbol3DLayer, PolygonSymbol3D, SceneView, PopupTemplate, Home, Query
) {
  ...
  var popupTemplate = new PopupTemplate({
        ...
        title: "Steph Curry Attempted {Point_Count} Shots"
  });
